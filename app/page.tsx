...
const HomeContent = () => {
  ...
  return (
    <div className="container">
      ...
      <header>
        <h1 className="text-3xl md:text-4xl font-bold mb-4 text-center">智能展馆多媒体中控系统</h1>
      </header>
      ...
      <section>
        ...
        <ol>
          <li>
            <strong>精细设备控制</strong>：通过控制面板实现对投影机、电脑主机开关机、照明灯电源、播放器、播放软件和音视频内容的精细控制
          </li>
          <li>
            <strong>独立群组运行</strong>：每个子展项可内部独立成组，无需依赖外网和服务器，实现设备间的本地链接和通讯
          </li>
          <li>
            <strong>灵活群组集成</strong>：当需要集成多个群组（展项）时，可快速接入中央服务器，并通过平板电脑进行集中控制，支持多级权限管理
          </li>
          <li>
            <strong>高性能播放终端</strong>：采用基于Linux的嵌入式播放器，内置画面几何校正和H5页面渲染功能，充分利用GPU和解码器硬件加速能力
          </li>
        </ol>
        <p>
      ...
      <section>
        ...
        <h3>多层级分布式设计</h3>
        <p>系统采用创新的群组化架构，实现了"独立运行与集中管理"的双重优势：</p>
        <ol>
          <li>
            <strong>独立群组结构</strong>：每个子展项作为独立群组，由ESP32Touch面板作为主节点，群组内部通过BLE GATT实现设备间本地通信，无需依赖外网和服务器
          </li>
          <li>
            <strong>群组快速集成</strong>：支持群组的即插即用式接入，通过WiFi连接到中央MQTT服务器，实现跨群组的统一控制
          </li>
          <li>
            <strong>灵活扩展</strong>：可根据展览规模动态调整群组数量和组织结构，支持从单一展项到大型展览馆的全方位覆盖
          </li>
        </ol>
        ...
        <ul>
          <li>
            <strong>中央控制系统</strong>：MQTT服务器作为群组集成核心，支持多展项集中管理和多级权限控制
          </li>
          <li>
            <strong>群组主节点</strong>：ESP32Touch面板，作为每个子展项的控制中心和人机交互界面，实现对所有设备的精细化控制
          </li>
          <li>
            <strong>设备控制节点</strong>：ESP32继电器模块（控制电源开关）、ESP32 RS232模块（控制串口设备）、ESP32 HID模块（模拟键盘鼠标）等
          </li>
          <li>
            <strong>智能播放终端</strong>：基于Linux的嵌入式播放器，内置GPU硬件加速和硬件解码器，支持画面几何校正和H5页面渲染
          </li>
          <li>
            <strong>移动控制终端</strong>：平板电脑APP，提供直观的集中控制界面和权限管理功能
          </li>
        </ul>
      </section>
